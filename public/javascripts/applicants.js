...
const btnFirstProgram = document.getElementById('btn-first-next-program');
const btnSecondProgram = document.getElementById('btn-second-next-program');
const btnSecondProgramPre = document.getElementById('btn-second-previous-program');
const btnThirdProgramPre = document.getElementById('btn-third-previous-program');
const btnApplyProgram = document.getElementById('btn-apply-program');
...
// 프로그램 신청 페이지 이동
if (btnFirstProgram) {
    btnFirstProgram.addEventListener('click', () => {
        const check = document.getElementById('counsel-info-agree');
...
if (btnSecondProgramPre) {
    btnSecondProgramPre.addEventListener('click', () => {
        moveAppPage(1);
    });
} else {}

if (btnThirdProgramPre) {
    btnThirdProgramPre.addEventListener('click', () => {
        moveAppPage(2);
    });
} else {}

if (btnSecondProgram) {
    btnSecondProgram.addEventListener('click', () => {
        // const category = document.getElementById('category');
...
if (btnApplyProgram) {
    btnApplyProgram.addEventListener('click', () => {
        const check = document.getElementById('counsel-agree');
        ...
        if (!check.checked) {
            ...
            const program_id = query.get('id') ? query.get('id') : document.getElementById('program').value;
...
function nameValue(name) {
    const temp = document.getElementsByName(`${name}`);
